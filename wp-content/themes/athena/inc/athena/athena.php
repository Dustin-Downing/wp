    ...
    <div id="athena-featured">
        ...
        <div class="col-sm-4 featured-box featured-box3" data-target="<?php echo esc_url( get_theme_mod( 'callout3_href', '#' ) ); ?>">
            ...
            <div class="reveal animated fadeInUp delay2">
                ...
                <p class="athena-desc"><?php echo esc_attr(get_theme_mod('callout3_text', __('Athena supports WooCommerce to build an online shopping site', 'athena'))); ?>
                  <p> Mon-Sat 11pm to 3pm and 5pm to 9pm</p>
                  <p> Sun 11pm to 9pm </p>
                </p>
